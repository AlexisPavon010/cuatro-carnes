...
export { recoveryPassword, registerUser, resetPassword, updateUser } from "./Users";
...
export { createOptions, getOptionById, updateOptions, createItemOptions, updateItemOptions, getItemOptionById, deletedItemOptions } from "./Options";